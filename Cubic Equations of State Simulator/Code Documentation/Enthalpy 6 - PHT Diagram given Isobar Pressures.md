# PHT Diagram given Isobar Pressures

This is the sixth option in the enthalpy menu. Its interface is programmed in "Enthalpy6.mlapp" and it uses the function called "PHT_Diagram_given_Isobar_Pressures.m" for thermodynamic calculations.
...
classdef Enthalpy6 < matlab.apps.AppBase
    ...
    properties (Access = public)
        PHTDiagramgivenIsobarPressuresUIFigure  matlab.ui.Figure
        ...
        PHTDiagramgivenIsobarPressuresLabel  matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            clc;
            movegui(app.PHTDiagramgivenIsobarPressuresUIFigure,"north");
            % Compound
        ...
        function CalculateButtonPushed(app, event)
            ...
            if tam>0 && app.ReferenceState.Value~="NaN" && app.ReferenceTemperature.Value~="NaN" && app.ReferencePressure.Value~="NaN" && app.ReferenceEnthalpy.Value~="NaN"
                progressbar=uiprogressdlg(app.PHTDiagramgivenIsobarPressuresUIFigure,"Title","Status","Message","Calculating","Indeterminate","on","Cancelable","off");
                drawnow;
                PHT_Diagram_given_Isobar_Pressures;
                close(progressbar);
            elseif app.ReferenceState.Value=="NaN" || app.ReferenceTemperature.Value=="NaN" || app.ReferencePressure.Value=="NaN" || app.ReferenceEnthalpy.Value=="NaN"
                uialert(app.PHTDiagramgivenIsobarPressuresUIFigure,"Incomplete Data.","Data Status","Icon","warning");
            else
                uialert(app.PHTDiagramgivenIsobarPressuresUIFigure,"Input isobar pressures not found.","Data Status","Icon","warning");
            end
        end
    end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create PHTDiagramgivenIsobarPressuresUIFigure and hide until all components are created
            app.PHTDiagramgivenIsobarPressuresUIFigure = uifigure('Visible', 'off');
            app.PHTDiagramgivenIsobarPressuresUIFigure.Color = [1 1 1];
            app.PHTDiagramgivenIsobarPressuresUIFigure.Position = [100 100 943 632];
            app.PHTDiagramgivenIsobarPressuresUIFigure.Name = 'PHT Diagram given Isobar Pressures';
            app.PHTDiagramgivenIsobarPressuresUIFigure.Icon = 'Logoico.png';
            app.PHTDiagramgivenIsobarPressuresUIFigure.Resize = 'off';

            % Create Figure1
            app.Figure1 = uiaxes(app.PHTDiagramgivenIsobarPressuresUIFigure);
            title(app.Figure1, 'EoS - Compound')
            ...
            % Create Image
            app.Image = uiimage(app.PHTDiagramgivenIsobarPressuresUIFigure);
            app.Image.Position = [45 462 127 103];
            app.Image.ImageSource = fullfile(pathToMLAPP, 'Logoico.png');

            % Create PHTDiagramgivenIsobarPressuresLabel
            app.PHTDiagramgivenIsobarPressuresLabel = uilabel(app.PHTDiagramgivenIsobarPressuresUIFigure);
            app.PHTDiagramgivenIsobarPressuresLabel.HorizontalAlignment = 'center';
            app.PHTDiagramgivenIsobarPressuresLabel.FontSize = 20;
            app.PHTDiagramgivenIsobarPressuresLabel.FontWeight = 'bold';
            app.PHTDiagramgivenIsobarPressuresLabel.FontColor = [0.1412 0.302 0.4784];
            app.PHTDiagramgivenIsobarPressuresLabel.Position = [1 589 943 26];
            app.PHTDiagramgivenIsobarPressuresLabel.Text = 'PHT Diagram given Isobar Pressures';

            % Create BackButton
            app.BackButton = uibutton(app.PHTDiagramgivenIsobarPressuresUIFigure, 'push');
            ...
            app.CubicEquationofStateDropDownLabel = uilabel(app.PHTDiagramgivenIsobarPressuresUIFigure);
            ...
            % Create EoS
            app.EoS = uidropdown(app.PHTDiagramgivenIsobarPressuresUIFigure);
            ...
            app.CompoundDropDownLabel = uilabel(app.PHTDiagramgivenIsobarPressuresUIFigure);
            ...
            % Create Compound
            app.Compound = uidropdown(app.PHTDiagramgivenIsobarPressuresUIFigure);
            app.Compound.Items = {};
            ...
            app.CalculateButton = uibutton(app.PHTDiagramgivenIsobarPressuresUIFigure, 'push');
            ...
            % Create Label
            app.Label = uilabel(app.PHTDiagramgivenIsobarPressuresUIFigure);
            ...
            % Create StateLabel
            app.StateLabel = uilabel(app.PHTDiagramgivenIsobarPressuresUIFigure);
            ...
            app.ReferenceState = uieditfield(app.PHTDiagramgivenIsobarPressuresUIFigure, 'text');
            app.ReferenceState.Editable = 'off';
            app.ReferenceState.Position = [732 539 176 22];

            % Create TemperatureKLabel
            app.TemperatureKLabel = uilabel(app.PHTDiagramgivenIsobarPressuresUIFigure);
            ...
            app.ReferenceTemperature = uieditfield(app.PHTDiagramgivenIsobarPressuresUIFigure, 'text');
            app.ReferenceTemperature.Editable = 'off';
            app.ReferenceTemperature.Position = [732 513 176 22];

            % Create PressurebarEditFieldLabel
            app.PressurebarEditFieldLabel = uilabel(app.PHTDiagramgivenIsobarPressuresUIFigure);
            ...
            app.ReferencePressure = uieditfield(app.PHTDiagramgivenIsobarPressuresUIFigure, 'text');
            app.ReferencePressure.Editable = 'off';
            app.ReferencePressure.Position = [732 488 176 22];

            % Create EnthalpykJkgLabel
            app.EnthalpykJkgLabel = uilabel(app.PHTDiagramgivenIsobarPressuresUIFigure);
            ...
            app.ReferenceEnthalpy = uieditfield(app.PHTDiagramgivenIsobarPressuresUIFigure, 'text');
            app.ReferenceEnthalpy.Editable = 'off';
            app.ReferenceEnthalpy.Position = [732 462 176 22];

            % Show the figure after all components are created
            app.PHTDiagramgivenIsobarPressuresUIFigure.Visible = 'on';
        end
    end
    ...
    methods (Access = public)
        ...
        function delete(app)
            ...
            delete(app.PHTDiagramgivenIsobarPressuresUIFigure)
        end
    end
end
```
