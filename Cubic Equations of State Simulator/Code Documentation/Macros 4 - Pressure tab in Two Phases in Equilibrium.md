...
<img src="https://github.com/IMClick-Project/IQ/blob/main/Cubic%20Equations%20of%20State%20Simulator/Code%20Documentation/macros4-1.jpg" width="1038" height="433">
        ...
        With Workbooks("Two Phases in Equilibrium.xlsm").Worksheets("Pressure")
            ...
            While Workbooks("Two-Phase Envelope on a TV Diagram.xlsm").Worksheets("TV Diagram").Cells(6 + 3 * row, 1).Value <> ""
                If Workbooks("Two-Phase Envelope on a TV Diagram.xlsm").Worksheets("TV Diagram").Cells(6 + 3 * row, 3).Value <> "NaN" Then
                    .Cells(12 + row_data, 1).Value = Workbooks("Two-Phase Envelope on a TV Diagram.xlsm").Worksheets("TV Diagram").Cells(6 + 3 * row, 2).Value
                    .Cells(12 + row_data, 2).Value = Workbooks("Two-Phase Envelope on a TV Diagram.xlsm").Worksheets("TV Diagram").Cells(6 + 3 * row, 3).Value
                    ...
                    .Cells(12 + row_data, 5).Value = Workbooks("Two-Phase Envelope on a TV Diagram.xlsm").Worksheets("TV Diagram").Cells(6 + 3 * row, 6).Value
                    .Cells(12 + row_data, 6).Value = Workbooks("Two-Phase Envelope on a TV Diagram.xlsm").Worksheets("TV Diagram").Cells(6 + 3 * row, 7).Value
                    .Cells(12 + row_data, 7).Value = Workbooks("Two-Phase Envelope on a TH Diagram.xlsm").Worksheets("TH Diagram").Cells(10 + 3 * row, 6).Value
                    .Cells(12 + row_data, 8).Value = Workbooks("Two-Phase Envelope on a TH Diagram.xlsm").Worksheets("TH Diagram").Cells(10 + 3 * row, 7).Value
                    .Cells(12 + row_data, 9).Value = Workbooks("Two-Phase Envelope on a TS Diagram.xlsm").Worksheets("TS Diagram").Cells(10 + 3 * row, 6).Value
                    .Cells(12 + row_data, 10).Value = Workbooks("Two-Phase Envelope on a TS Diagram.xlsm").Worksheets("TS Diagram").Cells(10 + 3 * row, 7).Value
                    row_data = row_data + 1
                End If
                row = row + 1
            Wend
            If row_data = 0 Then
                ...
                Exit Sub
            End If
            .Range("B3:B8").Value = Workbooks("Two-Phase Envelope on a TH Diagram.xlsm").Worksheets("TH Diagram").Range("B1:B6").Value
            .Range("B9").Value = Workbooks("Two-Phase Envelope on a TS Diagram.xlsm").Worksheets("TS Diagram").Range("B6").Value
            ' Format
