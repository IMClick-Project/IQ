# Two-Phase Envelope on a TS Diagram

This is the fifth option in the entropy menu. Its interface is programmed in "Entropy5.mlapp" and it uses the function called "Two_Phase_TS_Diagram.m" for thermodynamic calculations.

## 1. MATLAB App

### 1.1. Design View

<img src="https://github.com/IMClick-Project/IQ/blob/main/Cubic%20Equations%20of%20State%20Simulator/Code%20Documentation/entropy5.jpg" width="723" height="535">

*Figure 1. Design View in Entropy5.mlapp.*

### 1.2. Code View

```Matlab
classdef Entropy5 < matlab.apps.AppBase

    % Properties that correspond to app components
    properties (Access = public)
        TwoPhaseEnvelopeonaTSDiagramUIFigure  matlab.ui.Figure
        ...
        TwoPhaseEnvelopeonaTSDiagramLabel  matlab.ui.control.Label
    ...
    methods (Access = private)
        ...
        function startupFcn(app)
            clc;
            movegui(app.TwoPhaseEnvelopeonaTSDiagramUIFigure,"north");
            % Compound
        ...
        function CalculateButtonPushed(app, event)
            ...
            if tam>0 && app.ReferenceState.Value~="NaN" && app.ReferenceTemperature.Value~="NaN" && app.ReferencePressure.Value~="NaN" && app.ReferenceEntropy.Value~="NaN"
                progressbar=uiprogressdlg(app.TwoPhaseEnvelopeonaTSDiagramUIFigure,"Title","Status","Message","Calculating","Indeterminate","on","Cancelable","off");
                drawnow;
                Two_Phase_TS_Diagram;
            ...
            elseif app.ReferenceState.Value=="NaN" || app.ReferenceTemperature.Value=="NaN" || app.ReferencePressure.Value=="NaN" || app.ReferenceEntropy.Value=="NaN"
                uialert(app.TwoPhaseEnvelopeonaTSDiagramUIFigure,"Incomplete Data.","Data Status","Icon","warning");
            else
                uialert(app.TwoPhaseEnvelopeonaTSDiagramUIFigure,"Input isobar pressures not found.","Data Status","Icon","warning");
            end
        end
        ...
        function ExportButtonPushed(app, event)
            progressbar=uiprogressdlg(app.TwoPhaseEnvelopeonaTSDiagramUIFigure,"Title","Status","Message","Exporting","Indeterminate","on","Cancelable","off");
            drawnow;
            aux=app.Table1.Data;
            ...
            writecell(cell(5000,7),"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A1");
            writetable(table1,"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A9");
            writecell({'Compound'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A1");
            writecell({'Cubic Equation of State'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A2");
            writecell({'Reference State'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A3");
            writecell({'Reference Temperature [K]'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A4");
            writecell({'Reference Pressure [bar]'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A5");
            writecell({'Reference Entropy [kJ/kg/K]'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A6");
            writecell({'Critical Temperature [K]'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A7");
            writecell({'Calculated Critical Entropy [kJ/kg/K]'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","A8");
            writecell({app.Compound.Value},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","B1");
            writecell({app.EoS.Value},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","B2");
            writecell({app.ReferenceState.Value},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","B3");
            writematrix(str2double({app.ReferenceTemperature.Value}),"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","B4");
            writematrix(str2double({app.ReferencePressure.Value}),"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","B5");
            writematrix(str2double({app.ReferenceEntropy.Value}),"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","B6");
            writematrix(str2double({app.CriticalTemperature.Value}),"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","B7");
            writematrix(str2double({app.CriticalEntropy.Value}),"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range","B8");
            for i=12:3:5+height(table1)
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i,3,i,3])))
                    writecell({'NA'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['C',num2str(i)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i,4,i,4])))
                    writecell({'NA'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['D',num2str(i)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i,5,i,5])))
                    writecell({'NA'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['E',num2str(i)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i,6,i,6])))
                    writecell({'NA'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['F',num2str(i)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i,7,i,7])))
                    writecell({'NA'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['G',num2str(i)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i-2,3,i-2,3])))
                    writecell({'NaN'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['C',num2str(i-2)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i-2,4,i-2,4])))
                    writecell({'NaN'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['D',num2str(i-2)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i-2,5,i-2,5])))
                    writecell({'NaN'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['E',num2str(i-2)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i-2,6,i-2,6])))
                    writecell({'NaN'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['F',num2str(i-2)]);
                end
                if ismissing(string(readcell("./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",[i-2,7,i-2,7])))
                    writecell({'NaN'},"./Results/Two-Phase Envelope on a TS Diagram.xlsx","Sheet","TS Diagram","Range",['G',num2str(i-2)]);
                end
            end
            close(progressbar);
            uialert(app.TwoPhaseEnvelopeonaTSDiagramUIFigure,"Finished Export.","Export Status","Icon","success");
        end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            % Create TwoPhaseEnvelopeonaTSDiagramUIFigure and hide until all components are created
            app.TwoPhaseEnvelopeonaTSDiagramUIFigure = uifigure('Visible', 'off');
            app.TwoPhaseEnvelopeonaTSDiagramUIFigure.Color = [1 1 1];
            app.TwoPhaseEnvelopeonaTSDiagramUIFigure.Position = [100 100 902 667];
            app.TwoPhaseEnvelopeonaTSDiagramUIFigure.Name = 'Two-Phase Envelope on a TS Diagram';
            app.TwoPhaseEnvelopeonaTSDiagramUIFigure.Icon = fullfile(pathToMLAPP, 'Logoico.png');
            app.TwoPhaseEnvelopeonaTSDiagramUIFigure.Resize = 'off';

            % Create Figure1
            app.Figure1 = uiaxes(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            title(app.Figure1, 'EoS - Compound')
            ...
            % Create Table1
            app.Table1 = uitable(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            app.Table1.ColumnName = {'Method'; 'Psat [bar]'; 'Tsat [K]'; 'Zliquid'; 'Zvapor'; 'Sliquid [kJ/kg/K]'; 'Svapor [kJ/kg/K]'};
            app.Table1.RowName = {};
            app.Table1.Position = [571 191 249 257];

            % Create Label_2
            app.Label_2 = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            % Create ExportButton
            app.ExportButton = uibutton(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'push');
            ...
            % Create BackButton
            app.BackButton = uibutton(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'push');
            ...
            app.TemperatureKLabel_2 = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.CriticalTemperature = uieditfield(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'text');
            app.CriticalTemperature.Editable = 'off';
            app.CriticalTemperature.Position = [691 125 176 22];

            % Create Enthlalpym3kgLabel
            app.Enthlalpym3kgLabel = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.CriticalEntropy = uieditfield(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'text');
            app.CriticalEntropy.Editable = 'off';
            app.CriticalEntropy.Position = [691 91 176 22];

            % Create CalculateButton
            app.CalculateButton = uibutton(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'push');
            ...
            % Create Image
            app.Image = uiimage(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            app.Image.Position = [25 506 116 101];
            app.Image.ImageSource = fullfile(pathToMLAPP, 'Logoico.png');

            % Create TwoPhaseEnvelopeonaTSDiagramLabel
            app.TwoPhaseEnvelopeonaTSDiagramLabel = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            app.TwoPhaseEnvelopeonaTSDiagramLabel.HorizontalAlignment = 'center';
            app.TwoPhaseEnvelopeonaTSDiagramLabel.FontSize = 20;
            app.TwoPhaseEnvelopeonaTSDiagramLabel.FontWeight = 'bold';
            app.TwoPhaseEnvelopeonaTSDiagramLabel.FontColor = [0.1412 0.302 0.4784];
            app.TwoPhaseEnvelopeonaTSDiagramLabel.Position = [1 628 907 26];
            app.TwoPhaseEnvelopeonaTSDiagramLabel.Text = 'Two-Phase Envelope on a TS Diagram';

            % Create Label_3
            app.Label_3 = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.CubicEquationofStateDropDownLabel = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            % Create EoS
            app.EoS = uidropdown(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.CompoundDropDownLabel = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            % Create Compound
            app.Compound = uidropdown(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            app.Compound.Items = {};
            ...
            % Create StateLabel
            app.StateLabel = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.ReferenceState = uieditfield(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'text');
            app.ReferenceState.Editable = 'off';
            app.ReferenceState.Position = [691 577 176 22];

            % Create TemperatureKLabel
            app.TemperatureKLabel = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.ReferenceTemperature = uieditfield(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'text');
            app.ReferenceTemperature.Editable = 'off';
            app.ReferenceTemperature.Position = [691 551 176 22];

            % Create PressurebarEditFieldLabel_2
            app.PressurebarEditFieldLabel_2 = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.ReferencePressure = uieditfield(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'text');
            app.ReferencePressure.Editable = 'off';
            app.ReferencePressure.Position = [691 526 176 22];

            % Create EnthalpykJkgLabel
            app.EnthalpykJkgLabel = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.ReferenceEntropy = uieditfield(app.TwoPhaseEnvelopeonaTSDiagramUIFigure, 'text');
            app.ReferenceEntropy.Editable = 'off';
            app.ReferenceEntropy.Position = [691 500 176 22];

            % Create Label_4
            app.Label_4 = uilabel(app.TwoPhaseEnvelopeonaTSDiagramUIFigure);
            ...
            app.TwoPhaseEnvelopeonaTSDiagramUIFigure.Visible = 'on';
        end
    end
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = Entropy5

            % Create UIFigure and components
            createComponents(app)

            % Register the app with App Designer
            registerApp(app, app.TwoPhaseEnvelopeonaTSDiagramUIFigure)
        ...
        function delete(app)
            ...
            delete(app.TwoPhaseEnvelopeonaTSDiagramUIFigure)
        end
    end
end
```
