...
Private Sub COMPUTE_3_Click()
    ...
    If FUGACITY_TEST_3.Value = True Then
        ...
        With Workbooks("One Phase.xlsm").Worksheets("Temperature")
            ' Export results
            .Range("B3:B9").Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Range("B1:B7").Value
            .Range("B10").Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Range("B7").Value
            ' Liquid
            row_liquid = 0
            While Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 1).Value = "Liquid"
                If .Range("H4").Value = "P [bar]" Then
                    .Cells(14 + row_liquid, 1).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 2).Value
                    ...
                    .Cells(14 + row_liquid, 3).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 4).Value
                    .Cells(14 + row_liquid, 4).Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(9 + row_liquid, 4).Value
                    .Cells(14 + row_liquid, 5).Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(9 + row_liquid, 4).Value
                ElseIf .Range("H4").Value = "V [m3/kg]" Then
                    .Cells(14 + row_liquid, 3).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 2).Value
                    .Cells(14 + row_liquid, 2).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 3).Value
                    .Cells(14 + row_liquid, 1).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 4).Value
                    .Cells(14 + row_liquid, 4).Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(9 + row_liquid, 4).Value
                    .Cells(14 + row_liquid, 5).Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(9 + row_liquid, 4).Value
                ElseIf .Range("H4").Value = "H [kJ/kg]" Then
                    .Cells(14 + row_liquid, 4).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 2).Value
                    .Cells(14 + row_liquid, 2).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 3).Value
                    .Cells(14 + row_liquid, 3).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 4).Value
                    .Cells(14 + row_liquid, 1).Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(9 + row_liquid, 4).Value
                    .Cells(14 + row_liquid, 5).Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(9 + row_liquid, 4).Value
                ElseIf .Range("H4").Value = "S [kJ/kg/K]" Then
                    .Cells(14 + row_liquid, 5).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 2).Value
                    .Cells(14 + row_liquid, 2).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 3).Value
                    .Cells(14 + row_liquid, 3).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(5 + row_liquid, 4).Value
                    .Cells(14 + row_liquid, 4).Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(9 + row_liquid, 4).Value
                    .Cells(14 + row_liquid, 1).Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(9 + row_liquid, 4).Value
                End If
            ...
            While Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 1).Value = "Vapor"
                If .Range("H4").Value = "P [bar]" Then
                    .Cells(14 + row_vapor, 12).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 2).Value
                    ...
                    .Cells(14 + row_vapor, 14).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 4).Value
                    .Cells(14 + row_vapor, 15).Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(15 + row_liquid + row_vapor, 4).Value
                    .Cells(14 + row_vapor, 16).Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(15 + row_liquid + row_vapor, 4).Value
                ElseIf .Range("H4").Value = "V [m3/kg]" Then
                    .Cells(14 + row_vapor, 14).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 2).Value
                    .Cells(14 + row_vapor, 13).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 3).Value
                    .Cells(14 + row_vapor, 12).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 4).Value
                    .Cells(14 + row_vapor, 15).Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(15 + row_liquid + row_vapor, 4).Value
                    .Cells(14 + row_vapor, 16).Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(15 + row_liquid + row_vapor, 4).Value
                ElseIf .Range("H4").Value = "H [kJ/kg]" Then
                    .Cells(14 + row_vapor, 15).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 2).Value
                    .Cells(14 + row_vapor, 13).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 3).Value
                    .Cells(14 + row_vapor, 14).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 4).Value
                    .Cells(14 + row_vapor, 12).Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(15 + row_liquid + row_vapor, 4).Value
                    .Cells(14 + row_vapor, 16).Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(15 + row_liquid + row_vapor, 4).Value
                ElseIf .Range("H4").Value = "S [kJ/kg/K]" Then
                    .Cells(14 + row_vapor, 16).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 2).Value
                    .Cells(14 + row_vapor, 13).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 3).Value
                    .Cells(14 + row_vapor, 14).Value = Workbooks("Isotherm given Temperature on a PV Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(11 + row_liquid + row_vapor, 4).Value
                    .Cells(14 + row_vapor, 15).Value = Workbooks("Isotherm given Temperature on a PH Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(15 + row_liquid + row_vapor, 4).Value
                    .Cells(14 + row_vapor, 12).Value = Workbooks("Isotherm given Temperature on a PS Diagram.xlsm").Worksheets("Isotherm given Temperature").Cells(15 + row_liquid + row_vapor, 4).Value
                End If
